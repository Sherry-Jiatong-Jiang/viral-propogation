...
const int X = 10;	//max demes, constant to be used to initialize array size later
int N = 10, Np = N * burst_size;//max bacteria, and max phages max phages where applicable????????????????
